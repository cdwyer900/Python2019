...
@author: j2
do stop words and ngrams for CA
"""
import nltk
...
fout = open('CASubSet180319NGram.txt','wt')
fout.truncate()
...
CA_stopwords = ['the','it','said','and','one','in','say','could','also',
                'say','told','sat mar', 'last modifi','would','monday','firm','using',
                'able','around','whether', 'mr','according','know']
...
word_tokens = word_tokenize(outCAstr)
