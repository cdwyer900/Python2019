...
"""
do cleaning for ngrams of 15
"""

fin = open('CAScrubFullTextPart14.txt','rt')
fout = open('CAScrubFullTextPart15.txt', 'wt')
fout.truncate()
...
ngram_list = nltk.ngrams(word_tokens,15)
