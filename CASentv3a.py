...
df = pd.read_csv('results031718.csv')
...
result3.plot(kind='bar',title='Negative Sentiment Results for 03-17-18 (mean, all results)',legend=False)

sub2.plot(kind='bar',title='Negative Sentiment Results for 03-17-18 (mean, n>9)',legend=False)
sub3=sub1['date']
sub3=sub3.sort_values()
sub3.plot(kind='bar',title='Number Articles Published 03-17-18',legend=False)
